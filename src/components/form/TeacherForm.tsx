...
const schema = z.object({
  ...
  img: typeof window !== "undefined" ? z.instanceof(File, { message: "Image is required" }) : z.any(),
});
...
const TeacherForm = ({type, data}: TeacherFormProps) => {
  ...
  return (
    <form className='flex flex-col gap-8' onSubmit={onSubmit}>
        <h4 className='text-xl font-semibold'>Create a new teacher</h4>
      ...
      <div className="flex flex-wrap justify-between gap-4">
        ...
        <div className='flex flex-col gap-2 w-full md:w-1/4'>
          ...
          <select className='w-full ring-[1.5px] ring-gray-300 p-2 rounded-md text-sm' {...register("sex")} defaultValue={data?.sex}>
